"""Parser for 2015 historical PMIS PDFs with Hour of Day headers."""
...
PARSER_NAME = "historical_2015_hour_of_day_pmis_pdfplumber"
PARSER_VERSION = "0.1.0"
LAYOUT_FAMILY = "hourly_checkpoint_pmis_total_customer_throughput_2015_hour_of_day"
...
class Historical2015HourOfDayPmisPdfplumberParser(
    pmis_parser.HistoricalPmisTotalCustomerThroughputHourlyCheckpointPdfplumberParser
):
    """Parse 2015 PMIS hourly tables that use the `Hour of Day` header."""
